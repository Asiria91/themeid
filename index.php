...
<main id="main" class="clear">
    ...
    <div class="video-bubble hero halfway-section">
        ...
        </div><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/hero.jpg" alt="undefined">
      </div>
      ...
      <ul class="swift-slide product-slide halfway-section">
        ...
        <li class="hero product">
          ...
          </div><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/honeywell.jpg" alt="undefined">
        </li>
        <li class="hero product">
          <div class="compartment">
            <div class="product__details">
      ...
      <div class="halfway-section">
        <ul class="partners">
          ...
          <li class="partners__item"><a href=""><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/descartes.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/honeywell.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/nicelabel.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/intellitrack.png" alt="undefined"></a></li>
          <li class="partners__item"><a href=""><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/zebra.png" alt="undefined"></a></li>
        </ul>
        <div class="bubble bubble--big bubble--white">
          <div class="compartment">
            <div class="blockquote-bubble clear">
                <figure class="shifted-asset shifted-asset--left"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/big-circle.jpg" alt="">
          ...
          <div class="grid">
            ...
            <div class="col-flush">
              <div class="callout callout--dark-blue callout--featured"><a href="" class="callout__details">
                  ...
                  <div class="callout__logo"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/honeywell-white.png" alt="undefined">
                  </div>
        ...
        <div class="social-feeds">
          <div class="compartment">
            <ul>
              ...
              <li><a href="" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/geeknetwork.png" class="full-width"></a></li>
            </ul>
          </div>
        </div>
        <div class="sign-up">
